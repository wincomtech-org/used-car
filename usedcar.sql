...
INSERT INTO `cmf_asset` VALUES ('9', '1', '7859', '1509075164', '1', '0', 'a50feb855bd4915314c848468de98fdfdb1ed7a3d5a9c12c664a1db3a249d40f', 'head_99.jpg', 'insurance/20171027/3e1d07a86364dd96885569ae00d729cc.jpg', 'a50feb855bd4915314c848468de98fdf', 'e191406e2b58133a72e91fa6cf554b3fe05360c7', 'jpg', null);
...
) ENGINE=InnoDB AUTO_INCREMENT=184 DEFAULT CHARSET=utf8mb4 COMMENT='权限规则表';
...
INSERT INTO `cmf_portal_post` VALUES ('34', '0', '1', '1', '1', '1', '1', '0', '0', '8', '0', '0', '1507876137', '1508913587', '1507876080', '0', '活动1', '', '', '', '&lt;p&gt;最新活动极简出&lt;/p&gt;', null, '{\"thumbnail\":\"\",\"template\":\"\"}');
...
INSERT INTO `cmf_theme_file` VALUES ('112', '1', '1', 'simpleboot3', '导航条', 'public/Nav', 'public/nav', '导航条模板文件', '{\"vars\":{\"company_name\":{\"title\":\"\\u516c\\u53f8\\u540d\\u79f0\",\"name\":\"company_name\",\"value\":\"\\u5927\\u901a\\u8f66\\u670d\",\"type\":\"text\",\"tip\":\"\",\"rule\":[]}}}', '{\"vars\":{\"company_name\":{\"title\":\"\\u516c\\u53f8\\u540d\\u79f0\",\"name\":\"company_name\",\"value\":\"ThinkCMF\",\"type\":\"text\",\"tip\":\"\",\"rule\":[]}}}', null);
...
CREATE TABLE `cmf_trade_order` (
  ...
  `status` smallint(6) NOT NULL DEFAULT '0' COMMENT '状态：千分位：-4000交易失败 -3000系统取消 -2000卖家取消 -1000买家取消 0000初始化状态 1000交易完成。百分位：100已支付。十分位：10已发货。个分位：1买家已评论 2卖家已评论 3双方已评论。',
  PRIMARY KEY (`id`),
  KEY `idx1` (`pay_id`),
  KEY `idx2` (`buyer_uid`),
  KEY `idx3` (`seller_uid`),
...
-- Records of cmf_user
-- ----------------------------
INSERT INTO `cmf_user` VALUES ('1', '1', 'admin', 'admin', '###b0b5b1441fcc40910db4b7d99d049ddf', 'admin@admin.com', '', 'avatar/20171017/4356606a071829d0a566386a422d9bc7.png', '0', '0', '0', '0', '', '', '1507865317', '1509182144', '127.0.0.1', '1', '', null);
INSERT INTO `cmf_user` VALUES ('2', '1', '超人不会飞', 'super', '###797fe4d0d1b299ac9b581f4fa4025dbb', 'super@qq.com', '', '', '0', '0', '0', '0', '', '', '0', '0', '', '1', '', null);
INSERT INTO `cmf_user` VALUES ('3', '1', '洛萨', 'lothar', '###797fe4d0d1b299ac9b581f4fa4025dbb', 'lothar@qq.com', '', '', '0', '0', '0', '0', '', '', '0', '1509181491', '127.0.0.1', '1', '', null);
...
CREATE TABLE `cmf_usual_car` (
  ...
  `identi_status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '认证审核状态： -1审核不通过 0未审核 1审核通过',
...
CREATE TABLE `cmf_usual_company` (
  ...
  `list_order` float unsigned NOT NULL DEFAULT '10000' COMMENT '排序：从小到大',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='公司表';

-- ----------------------------
-- Records of cmf_usual_company
-- ----------------------------
INSERT INTO `cmf_usual_company` VALUES ('1', '0', '10', '146', '锦平车险', '', '', '1508834130', '1508837504', '0', '0', '', '', '', '', '', '', '{\"thumbnail\":\"\"}', '1', '1', '0', '0', '0', '1', '10000');
INSERT INTO `cmf_usual_company` VALUES ('2', '0', '10', '146', '润之丰车险', '', '', '1508837547', '1508915613', '1508837460', '0', '', '', '', '&lt;p&gt;保障&lt;/p&gt;', '', '', '{\"thumbnail\":\"\"}', '1', '1', '0', '0', '0', '1', '10000');
INSERT INTO `cmf_usual_company` VALUES ('3', '0', '10', '146', '平安车险', '', '', '1508990912', '1509076369', '1508990700', '0', '', '', '总部：中国深圳', '', '', '', '{\"thumbnail\":\"http:\\/\\/pimg1.4008000000.com\\/app_images\\/4008000000\\/v20\\/index_b\\/logo.png\",\"photos\":[{\"url\":\"http:\\/\\/pimg1.4008000000.com\\/app_images\\/4008000000\\/v20\\/index_b\\/logo.png\",\"name\":\"\"},{\"url\":\"http:\\/\\/pimg1.4008000000.com\\/app_images\\/4008000000\\/v20\\/index_b\\/logo.png\",\"name\":\"\"}]}', '1', '0', '0', '0', '1', '1', '10000');
...
CREATE TABLE `cmf_usual_item` (
  ...
  `list_order` float unsigned NOT NULL DEFAULT '10000' COMMENT '排序：从小到大',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COMMENT='属性表';

-- ----------------------------
-- Records of cmf_usual_item
-- ----------------------------
INSERT INTO `cmf_usual_item` VALUES ('1', '0', '排放标准', '0', '0-1', '', '', '0', '10000');
INSERT INTO `cmf_usual_item` VALUES ('2', '0', '颜色', '0', '0-2', '', '', '0', '10000');
INSERT INTO `cmf_usual_item` VALUES ('3', '0', '车源类别', '0', '0-3', '', '', '0', '10000');
...
INSERT INTO `cmf_usual_models` VALUES ('9', '0', '7', '王朝', '', '', '0', '', '', '0', '{\"thumbnail\":\"\"}', '0-9', '10000', '', null, null);
