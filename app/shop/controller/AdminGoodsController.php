...
class AdminGoodsController extends AdminBaseController
{
    ...
    public function addPost()
    {
        ...
        if ($result['status'] === true) {
            lothar_admin_log('shop_goods', 'id:'.$result['post']['id'], 'name:'.$result['post']['name']);
    ...
    public function editPost()
    {
        ...
        if ($result['status'] === true) {
            // lothar_admin_log('shop_goods', 'id:'.$id, 'name:'.$result['post']['name']);
    ...
    public function delete()
    {
        ...
        if ($row === 1) {
            lothar_admin_log('shop_goods', 'id:'.$id, 'name:'.$name);
            $this->success('删除成功');
        } else {
            $this->error('删除失败');
        }
