...
$.noty.defaults = {
    ...
    template: '<div class="noty_message"><span class="noty_text" '+ 'style="color:rgb(123, 82, 29);"' +'></span><div class="noty_close"></div></div>',
    animation: {
        open: {
            height: 'toggle'
        },
    ...
    closeWith: ['click'],
    // ['click', 'button', 'hover', 'backdrop'] // backdrop click will close all open notifications
    callback: {
        onShow: function() {},
        afterShow: function() {},
        onClose: function() {},
