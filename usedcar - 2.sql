...
CREATE TABLE `cmf_usual_brand` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COMMENT='品牌表';
...
INSERT INTO `cmf_usual_brand` VALUES ('23', '0', '别克', '', '', '*', '0', '', '美国通用汽车公司', '0', '{\"thumbnail\":\"http:\\/\\/www.buick.com.cn\\/img\\/shared\\/logo_buick.png\"}', '0-23', '10000', '', '', '');
...
CREATE TABLE `cmf_usual_item` (
  ...
  `list_order` float unsigned NOT NULL DEFAULT '10000' COMMENT '排序：从小到大',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='属性表';
...
INSERT INTO `cmf_usual_item` VALUES ('5', '0', '三星', '0-5', '1508727557', '', '', '0', '10000');
